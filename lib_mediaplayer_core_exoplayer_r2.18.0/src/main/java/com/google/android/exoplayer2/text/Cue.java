...
public final class Cue implements Bundleable {
  ...
  /** Returns a new {@link Builder} initialized with the same values as this Cue. */
  ...
  public static final class Builder {
     ...
     */
    public Builder setTextAlignment(@Nullable Alignment textAlignment) {
      this.textAlignment = textAlignment;
      return this;
    }
     ...
     */
    public Builder setMultiRowAlignment(@Nullable Alignment multiRowAlignment) {
      this.multiRowAlignment = multiRowAlignment;
      return this;
    }
