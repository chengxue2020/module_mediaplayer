...
*/
package lib.kalu.mediaplayer.videoui.ui.view;
 ...
 */
@Keep
public class DefaultControllerMobile extends ControllerLayoutForGesture implements View.OnClickListener {
    ...
    public DefaultControllerMobile(@NonNull Context context) {
        this(context, null);
    }

    public DefaultControllerMobile(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DefaultControllerMobile(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void addDefaultControlComponent(String title) {
        ...
        //添加标题栏
        titleView = new CustomTitleView(getContext());
