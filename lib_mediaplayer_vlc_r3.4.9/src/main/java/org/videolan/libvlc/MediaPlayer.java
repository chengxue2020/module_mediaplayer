...
//        public static final int ChapterChanged      = 0x11d;
        ...
        protected Event(int type, long arg1, String args1) {
...
//    private VideoHelper mVideoHelper = null;
     ...
     * @throws IOException
     */
    public void playAsset(Context context, String assetFilename) throws IOException {
    ...
    @Override
    protected synchronized Event onEventNative(int eventType, long arg1, long arg2, float argf1, String args1) {
        switch (eventType) {
