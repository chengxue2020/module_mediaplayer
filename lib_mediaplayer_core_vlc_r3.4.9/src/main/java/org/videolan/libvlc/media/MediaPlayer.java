...
public class MediaPlayer {
    ...
    public MediaPlayer(Context context) {
        mILibVLC = new LibVLC(context); //FIXME, this is wrong
...
//    }
    ...
    public org.videolan.libvlc.MediaPlayer getVLC() {
        return mMediaPlayer;
    }
    ...
    public void seekTo(long seek) {
        mMediaPlayer.setPosition(seek, true);
    }
    ...
    static public class TrackInfo implements Serializable {
