...
#define FFMPEG_CONFIGURATION "--arch=x86_64 --enable-yasm --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --disable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-filters --disable-iconv --enable-protocol=async --prefix=/home/kalu/Downloads/ijkplayer-k0.8.8-ff4.0/android/contrib/build/ffmpeg-x86_64/output --cross-prefix=x86_64-linux-android- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/kalu/Downloads/ijkplayer-k0.8.8-ff4.0/android/contrib/build/openssl-x86_64/output/include ' --extra-ldflags=' -L/home/kalu/Downloads/ijkplayer-k0.8.8-ff4.0/android/contrib/build/openssl-x86_64/output/lib -lssl -lcrypto '"
