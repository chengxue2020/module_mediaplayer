...
public final class FileTypes {
  ...
  public static @Type int inferFileTypeFromResponseHeaders(
   ...
   */
  public static @Type int inferFileTypeFromMimeType(@Nullable String mimeType) {
    if (mimeType == null) {
  ...
  public static @Type int inferFileTypeFromUri(Uri uri) {
