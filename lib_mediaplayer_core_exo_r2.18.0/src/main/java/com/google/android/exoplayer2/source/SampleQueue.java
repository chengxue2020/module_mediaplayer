...
public class SampleQueue implements TrackOutput {
  ...
  @Nullable private final EventDispatcher drmEventDispatcher;
   ...
   * @param drmEventDispatcher A {@link EventDispatcher} to notify of events
  ...
  protected SampleQueue(
      ...
      @Nullable EventDispatcher drmEventDispatcher) {
