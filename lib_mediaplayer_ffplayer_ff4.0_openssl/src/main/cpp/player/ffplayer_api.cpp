/*
 * FFmpegPlayer: A unified interface for playing audio files and streams.
 *
...
//#define LOG_NDEBUG 0
#define LOG_TAG "FFmpegPlayer-JNI"
...
JNIMediaPlayerListener::JNIMediaPlayerListener(JNIEnv *env, jobject thiz, jobject weak_thiz) {
    ...
    if (clazz == NULL) {
        __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "Can't find lib/kalu/FFmpegPlayer");
...
//void JNIMediaPlayerListener::notify(int msg, int ext1, int ext2, const Parcel *obj)
{
    ...
    if (env->ExceptionCheck()) {
        __android_log_print(ANDROID_LOG_WARN, LOG_TAG,
                            "An exception occurred while notifying an event.");
        //LOGW_EX(env);
        env->ExceptionClear();
    }
...
// application.
static void
process_media_player_call(JNIEnv *env, jobject thiz, int opStatus, const char *exception,
                          const char *message) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_setDataSourceAndHeaders(
    ...
    if (keys && values != NULL) {
        ...
        if (keysCount != valuesCount) {
            __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,
                                "keys and values arrays have different length");
            jniThrowException(env, "java/lang/IllegalArgumentException", NULL);
            return;
        }
...
static void
lib_kalu_ffplayer_FFmpegPlayer_prepare(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static void
lib_kalu_ffplayer_FFmpegPlayer_prepareAsync(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
    ...
    process_media_player_call(env, thiz, mp->prepareAsync(), "java/io/IOException",
                              "Prepare Async failed.");
}

static void
lib_kalu_ffplayer_FFmpegPlayer_start(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_stop(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_pause(JNIEnv *env, jobject thiz) {
...
static jboolean
lib_kalu_ffplayer_FFmpegPlayer_isPlaying(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return false;
...
static void
lib_kalu_ffplayer_FFmpegPlayer_seekTo(JNIEnv *env, jobject thiz, int msec) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
...
static int
lib_kalu_ffplayer_FFmpegPlayer_getVideoWidth(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static int
lib_kalu_ffplayer_FFmpegPlayer_getVideoHeight(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static int
lib_kalu_ffplayer_FFmpegPlayer_getCurrentPosition(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static int
lib_kalu_ffplayer_FFmpegPlayer_getDuration(JNIEnv *env, jobject thiz) {
    MediaPlayer *mp = getMediaPlayer(env, thiz);
    if (mp == NULL) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return 0;
...
static void
lib_kalu_ffplayer_FFmpegPlayer_reset(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_setAudioStreamType(JNIEnv *env, jobject thiz, int streamtype) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_setLooping(JNIEnv *env, jobject thiz, jboolean looping) {
...
static jboolean
lib_kalu_ffplayer_FFmpegPlayer_isLooping(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_native_init(JNIEnv *env) {
    __android_log_print(ANDROID_LOG_VERBOSE, LOG_TAG, "native_init");
    jclass clazz;

    clazz = env->FindClass("lib/kalu/ffplayer/FFmpegPlayer");
    if (clazz == NULL) {
        return;
    }
...
static void
lib_kalu_ffplayer_FFmpegPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_release(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_native_finalize(JNIEnv *env, jobject thiz) {
    ...
    lib_kalu_ffplayer_FFmpegPlayer_release(env, thiz);
}
...
static jint lib_kalu_ffplayer_FFmpegPlayer_get_audio_session_id(JNIEnv *env, jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_setAuxEffectSendLevel(JNIEnv *env, jobject thiz, jfloat level) {
...
static void
lib_kalu_ffplayer_FFmpegPlayer_attachAuxEffect(JNIEnv *env, jobject thiz, jint effectId) {
...
static JNINativeMethod gMethods[] = {
        {
                "_setDataSource",
                                            "(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V",
                                                                                          (void *) lib_kalu_ffplayer_FFmpegPlayer_setDataSourceAndHeaders
        },

        {       "_setDataSource",           "(Ljava/io/FileDescriptor;JJ)V",              (void *) lib_kalu_ffplayer_FFmpegPlayer_setDataSourceFD},
        {       "_setVideoSurface",         "(Landroid/view/Surface;)V",                  (void *) lib_kalu_ffplayer_FFmpegPlayer_setVideoSurface},
        {       "prepare",                  "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_prepare},
        {       "prepareAsync",             "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_prepareAsync},
        {       "_start",                   "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_start},
        {       "_stop",                    "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_stop},
        {       "getVideoWidth",            "()I",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_getVideoWidth},
        {       "getVideoHeight",           "()I",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_getVideoHeight},
        {       "seekTo",                   "(I)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_seekTo},
        {       "_pause",                   "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_pause},
        {       "isPlaying",                "()Z",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_isPlaying},
        {       "getCurrentPosition",       "()I",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_getCurrentPosition},
        {       "getDuration",              "()I",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_getDuration},
        {       "_release",                 "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_release},
        {       "_reset",                   "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_reset},
        {       "setAudioStreamType",       "(I)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_setAudioStreamType},
        {       "setLooping",               "(Z)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_setLooping},
        {       "isLooping",                "()Z",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_isLooping},
        {       "setVolume",                "(FF)V",                                      (void *) lib_kalu_ffplayer_FFmpegPlayer_setVolume},
        {       "native_setMetadataFilter", "([Ljava/lang/String;[Ljava/lang/String;)I",  (void *) lib_kalu_ffplayer_FFmpegPlayer_setMetadataFilter},
        {       "native_getMetadata",       "(ZZLjava/util/HashMap;)Ljava/util/HashMap;", (void *) lib_kalu_ffplayer_FFmpegPlayer_getMetadata},
        {       "native_init",              "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_native_init},
        {       "native_setup",             "(Ljava/lang/Object;)V",                      (void *) lib_kalu_ffplayer_FFmpegPlayer_native_setup},
        {       "native_finalize",          "()V",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_native_finalize},
        {       "getAudioSessionId",        "()I",                                        (void *) lib_kalu_ffplayer_FFmpegPlayer_get_audio_session_id},
        {       "setAudioSessionId",        "(I)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_set_audio_session_id},
        {       "setAuxEffectSendLevel",    "(F)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_setAuxEffectSendLevel},
        {       "attachAuxEffect",          "(I)V",                                       (void *) lib_kalu_ffplayer_FFmpegPlayer_attachAuxEffect},
        {       "setNextMediaPlayer",       "(Llib/kalu/ffplayer/FFmpegPlayer;)V",        (void *) lib_kalu_ffplayer_FFmpegPlayer_setNextMediaPlayer},
};

static const char *const kClassPathName = "lib/kalu/ffplayer/FFmpegPlayer";

// This function only registers the native methods
static int register_lib_kalu_ffplayer_FFmpegPlayer(JNIEnv *env) {
    int numMethods = (sizeof(gMethods) / sizeof((gMethods)[0]));
    jclass clazz = env->FindClass("lib/kalu/ffplayer/FFmpegPlayer");
    if (clazz == NULL) {
        __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,
                            "Native registration unable to find class 'lib/kalu/FFmpegPlayer'");
        return JNI_ERR;
    }
    if (env->RegisterNatives(clazz, gMethods, numMethods) < 0) {
        __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,
                            "RegisterNatives failed for 'lib/kalu/FFmpegPlayer'");
        return JNI_ERR;
    }
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_lib_kalu_ffplayer_FFmpegPlayer(env) < 0) {
        __android_log_print(ANDROID_LOG_ERROR, LOG_TAG,
                            "ERROR: FFmpegPlayer native registration failed\n");
        goto bail;
    }
