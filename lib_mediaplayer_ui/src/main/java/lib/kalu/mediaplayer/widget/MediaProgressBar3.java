...
public class MediaProgressBar3 extends TextView {

    public MediaProgressBar3(Context context) {
        super(context);
        init();
    }

    public MediaProgressBar3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MediaProgressBar3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MediaProgressBar3(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
