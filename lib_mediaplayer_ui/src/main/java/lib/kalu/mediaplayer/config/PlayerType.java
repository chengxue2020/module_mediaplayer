...
public class PlayerType {
    ...
    public @interface MediaType {
        ...
        @IntDef({MEDIA_INFO_VIDEO_SEEK_RENDERING_START, MEDIA_INFO_AUDIO_SEEK_RENDERING_START, MEDIA_INFO_URL_NULL, MEDIA_INFO_AUDIO_RENDERING_START, MEDIA_INFO_VIDEO_RENDERING_START, MEDIA_INFO_BUFFERING_START, MEDIA_INFO_BUFFERING_END, MEDIA_INFO_VIDEO_ROTATION_CHANGED, MEDIA_INFO_AUDIO_DECODED_START, MEDIA_INFO_VIDEO_DECODED_START})
        @Retention(RetentionPolicy.SOURCE)
        @Keep
        @interface Value {
        }
