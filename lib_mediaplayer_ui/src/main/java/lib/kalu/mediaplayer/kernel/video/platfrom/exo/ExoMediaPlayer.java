...
//                .build();
        ...
        //播放器日志
        if (mInternalPlayer.getTrackSelector() instanceof MappingTrackSelector) {
            mInternalPlayer.addAnalyticsListener(new EventLogger((MappingTrackSelector) mInternalPlayer.getTrackSelector(), "ExoPlayer"));
        }
        initListener();
    }
