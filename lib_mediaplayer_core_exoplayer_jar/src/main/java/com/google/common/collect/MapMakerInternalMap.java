...
class MapMakerInternalMap<
  ...
  /**
   * Returns a fresh {@link MapMakerInternalMap} with {@link Dummy} values but otherwise as
   * specified by the given {@code builder}. The returned {@link MapMakerInternalMap} will be
   * optimized to saved memory. Since {@link Dummy} is a singleton, we don't need to store
