package com.kalu.mediaplayer.newPlayer.surface;
...
public class MySurfaceView extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    ...
    protected void Draw() {
        ...
        if (mCanvas != null) {
            ...
            Bitmap pic = ((BitmapDrawable) getResources().getDrawable(R.drawable.module_mediaplayer_ic_player_share)).getBitmap();
