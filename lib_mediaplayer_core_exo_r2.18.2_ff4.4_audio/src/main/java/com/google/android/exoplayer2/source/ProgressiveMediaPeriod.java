...
//                    ExoLogUtil.log("loadPP => position = " + position);
                    dataSpec = buildDataSpec(position);
                    long length = dataSource.open(dataSpec);
//                    ExoLogUtil.log("loadPP => position = " + position + ", length = " + length);
...
//                    ExoLogUtil.log("loadPP => finally => result = " + result);
//                    ExoLogUtil.log("loadPP => finally => positionHolder.position = " + positionHolder.position);
//                    ExoLogUtil.log("loadPP => finally => progressiveMediaExtractor.getCurrentInputPosition() = " + progressiveMediaExtractor.getCurrentInputPosition());
