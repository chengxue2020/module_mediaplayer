...
public abstract class SimpleBasePlayer extends BasePlayer {
   ...
   */
  @ForOverride
  protected ListenableFuture2<?> handleSetDeviceVolume(@IntRange(from = 0) int deviceVolume) {
   ...
   */
  @ForOverride
  protected ListenableFuture2<?> handleIncreaseDeviceVolume() {
    throw new IllegalStateException(
   ...
   */
  @ForOverride
  protected ListenableFuture2<?> handleDecreaseDeviceVolume() {
    throw new IllegalStateException(
        "Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME");
  }
   ...
   */
  @ForOverride
  protected ListenableFuture2<?> handleSetDeviceMuted(boolean muted) {
    throw new IllegalStateException(
        "Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME");
  }
