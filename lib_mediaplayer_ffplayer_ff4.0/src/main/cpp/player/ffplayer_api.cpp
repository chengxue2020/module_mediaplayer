...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setDataSourceAndHeaders(
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setDataSourceFD(JNIEnv *env, jobject thiz, jobject fileDescriptor, jlong offset, jlong length)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setVideoSurface(JNIEnv *env, jobject thiz, jobject jsurface)
{
    setVideoSurface(env, thiz, jsurface, true /* mediaPlayerMustBeAlive */);
}

static void
lib_kalu_ffplayer_FFmpegMediaPlayer_prepare(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_prepareAsync(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_start(JNIEnv *env, jobject thiz)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_stop(JNIEnv *env, jobject thiz)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_pause(JNIEnv *env, jobject thiz)
{
...
static jboolean
lib_kalu_ffplayer_FFmpegMediaPlayer_isPlaying(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_seekTo(JNIEnv *env, jobject thiz, int msec)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static int
lib_kalu_ffplayer_FFmpegMediaPlayer_getVideoWidth(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static int
lib_kalu_ffplayer_FFmpegMediaPlayer_getVideoHeight(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static int
lib_kalu_ffplayer_FFmpegMediaPlayer_getCurrentPosition(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static int
lib_kalu_ffplayer_FFmpegMediaPlayer_getDuration(JNIEnv *env, jobject thiz)
{
    MediaPlayer* mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_reset(JNIEnv *env, jobject thiz)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setAudioStreamType(JNIEnv *env, jobject thiz, int streamtype)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setLooping(JNIEnv *env, jobject thiz, jboolean looping)
{
...
static jboolean
lib_kalu_ffplayer_FFmpegMediaPlayer_isLooping(JNIEnv *env, jobject thiz)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setVolume(JNIEnv *env, jobject thiz, float leftVolume, float rightVolume)
{
...
static jint
lib_kalu_ffplayer_FFmpegMediaPlayer_setMetadataFilter(JNIEnv *env, jobject thiz, jobjectArray allow, jobjectArray block)
{
...
static jobject
lib_kalu_ffplayer_FFmpegMediaPlayer_getMetadata(JNIEnv *env, jobject thiz, jboolean update_only,
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_native_init(JNIEnv *env)
{
    __android_log_print(ANDROID_LOG_VERBOSE, LOG_TAG, "native_init");
    jclass clazz;
    
    clazz = env->FindClass("lib/kalu/ffplayer/FFmpegMediaPlayer");
    if (clazz == NULL) {
        return;
    }
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_release(JNIEnv *env, jobject thiz)
{
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_native_finalize(JNIEnv *env, jobject thiz)
{
    ...
    lib_kalu_ffplayer_FFmpegMediaPlayer_release(env, thiz);
}

static void lib_kalu_ffplayer_FFmpegMediaPlayer_set_audio_session_id(JNIEnv *env,  jobject thiz, jint sessionId) {
...
static jint lib_kalu_ffplayer_FFmpegMediaPlayer_get_audio_session_id(JNIEnv *env,  jobject thiz) {
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setAuxEffectSendLevel(JNIEnv *env, jobject thiz, jfloat level)
{
...
static void lib_kalu_ffplayer_FFmpegMediaPlayer_attachAuxEffect(JNIEnv *env,  jobject thiz, jint effectId) {
...
static void
lib_kalu_ffplayer_FFmpegMediaPlayer_setNextMediaPlayer(JNIEnv *env, jobject thiz, jobject java_player)
{
...
static JNINativeMethod gMethods[] = {
    {
        ...
        (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setDataSourceAndHeaders
    },
    
    {"_setDataSource",       "(Ljava/io/FileDescriptor;JJ)V",    (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setDataSourceFD},
    {"_setVideoSurface",    "(Landroid/view/Surface;)V",        (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setVideoSurface},
    {"prepare",             "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_prepare},
    {"prepareAsync",        "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_prepareAsync},
    {"_start",              "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_start},
    {"_stop",               "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_stop},
    {"getVideoWidth",       "()I",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_getVideoWidth},
    {"getVideoHeight",      "()I",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_getVideoHeight},
    {"seekTo",              "(I)V",                             (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_seekTo},
    {"_pause",              "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_pause},
    {"isPlaying",           "()Z",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_isPlaying},
    {"getCurrentPosition",  "()I",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_getCurrentPosition},
    {"getDuration",         "()I",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_getDuration},
    {"_release",            "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_release},
    {"_reset",              "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_reset},
    {"setAudioStreamType",  "(I)V",                             (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setAudioStreamType},
    {"setLooping",          "(Z)V",                             (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setLooping},
    {"isLooping",           "()Z",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_isLooping},
    {"setVolume",           "(FF)V",                            (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setVolume},
    {"native_setMetadataFilter", "([Ljava/lang/String;[Ljava/lang/String;)I", (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setMetadataFilter},
    {"native_getMetadata", "(ZZLjava/util/HashMap;)Ljava/util/HashMap;", (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_getMetadata},
    {"native_init",         "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_native_init},
    {"native_setup",        "(Ljava/lang/Object;)V",          (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_native_setup},
    {"native_finalize",     "()V",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_native_finalize},
    {"getAudioSessionId",   "()I",                              (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_get_audio_session_id},
    {"setAudioSessionId",   "(I)V",                             (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_set_audio_session_id},
    {"setAuxEffectSendLevel", "(F)V",                           (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setAuxEffectSendLevel},
    {"attachAuxEffect",     "(I)V",                             (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_attachAuxEffect},
    {"setNextMediaPlayer", "(Llib/kalu/ffplayer/FFmpegMediaPlayer;)V", (void *)lib_kalu_ffplayer_FFmpegMediaPlayer_setNextMediaPlayer},
};

static const char* const kClassPathName = "lib/kalu/ffplayer/FFmpegMediaPlayer";

// This function only registers the native methods
static int register_lib_kalu_ffplayer_FFmpegMediaPlayer(JNIEnv *env)
{
    int numMethods = (sizeof(gMethods) / sizeof( (gMethods)[0]));
    jclass clazz = env->FindClass("lib/kalu/ffplayer/FFmpegMediaPlayer");
    if (clazz == NULL) {
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    if (register_lib_kalu_ffplayer_FFmpegMediaPlayer(env) < 0) {
