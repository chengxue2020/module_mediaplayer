...
*/
package lib.kalu.mediaplayer.videoui.old.controller;
...
import lib.kalu.mediaplayer.videoui.old.dialog.ChangeClarityDialog;
import lib.kalu.mediaplayer.videoui.R;
import lib.kalu.mediaplayer.videoui.old.listener.OnPlayerStatesListener;
import lib.kalu.mediaplayer.videoui.old.listener.OnPlayerTypeListener;
import lib.kalu.mediaplayer.videoui.old.player.OldVideoPlayer;
import lib.kalu.mediaplayer.videoui.old.other.BatterReceiver;
import lib.kalu.mediaplayer.videoui.old.other.NetChangedReceiver;
import lib.kalu.mediaplayer.videoui.old.listener.OnClarityChangedListener;
...
public class VideoPlayerController extends AbsVideoPlayerController implements View.OnClickListener{
    ...
    protected void onDetachedFromWindow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (pbLoadingRing!=null && pbLoadingRing.getVisibility()== VISIBLE){
                boolean animating = pbLoadingRing.isAnimating();
                if (animating){
                    pbLoadingRing.clearAnimation();
                }
            }
            if (pbLoadingQq!=null && pbLoadingQq.getVisibility()== VISIBLE){
    ...
    public void onPlayModeChanged(@ConstantKeys.PlayMode int playMode) {
        switch (playMode) {
            ...
            case ConstantKeys.PlayMode.MODE_NORMAL:
                ...
                //隐藏横屏的时候展现的布局
                mLlHorizontal.setVisibility(GONE);
            ...
            case ConstantKeys.PlayMode.MODE_FULL_SCREEN:
                ...
                mLlHorizontal.setVisibility(VISIBLE);
                mIvHorTv.setVisibility(mIsTvIconVisibility?VISIBLE:GONE);
                mIvHorAudio.setVisibility(mIsAudioIconVisibility?VISIBLE:GONE);
                setTopBottomVisible(true);
    ...
    private void setTopBottomVisible(boolean visible) {
        ...
        mLine.setVisibility(visible ? GONE : VISIBLE);
    ...
    private void setCenterVisible(boolean visible){
        mCenterStart.setVisibility(visible ? VISIBLE : GONE);
    }
