...
public class IMediaDataSourceForRaw implements IMediaDataSource {

    private AssetFileDescriptor mDescriptor;
    private byte[] mMediaBytes;

    public IMediaDataSourceForRaw(AssetFileDescriptor descriptor) {
    ...
    public static IMediaDataSourceForRaw create(Context context, Uri uri) {
        try {
            AssetFileDescriptor fileDescriptor = context.getContentResolver()
                    .openAssetFileDescriptor(uri, "r");
            return new IMediaDataSourceForRaw(fileDescriptor);
